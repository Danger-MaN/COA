        ...
        {candidates.map((c, i) => (
          ...
          >
            <div className="relative aspect-[3/4] overflow-hidden">
              <img src={c.image} alt={lang === 'ar' ? c.nameAr : c.nameEn} className="h-full w-full object-cover object-center transition-transform duration-700 group-hover:scale-105" loading="lazy" />
            ...
            <div className="p-3 text-start">
              <p className="text-sm font-semibold truncate">{lang === 'ar' ? c.nameAr : c.nameEn}</p>
